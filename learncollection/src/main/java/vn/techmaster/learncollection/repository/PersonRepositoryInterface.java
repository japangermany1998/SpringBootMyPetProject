...
public interface PersonRepositoryInterface {
  ...
  */
  ...
  HashMap<String, Float> averageCityAge();

  HashMap<String, Float> averageJobAge();

  HashMap<String, Float> averageJobSalary();

  List<String> find5CitiesHaveMostSpecificJob(String job);

  HashMap<String, Float> top5HighestSalaryCities();
}
